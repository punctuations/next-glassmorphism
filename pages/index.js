...
export default function Home() {
	return (
		<>
			...
			/>
			<main className="absolute w-screen h-screen bg-orange-400 dark:bg-black bg-image dark:bg-image-dark flex items-center justify-center transition-all duration-500 overflow-auto">
